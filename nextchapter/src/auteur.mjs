...
export async function getRecommendationsA(authors) {
    const completion = await openai.chat.completions.create({
        model: "gpt-4o-mini",
        messages: [
            { role: "system", content: "You are a helpful librarian that helps a client. He gives you a list of authors and you must recommend him some books written by other authors that have similarity with the authors the client gives. You need to give your answer in french." },
            {
                role: "user",
                content: authors,
            },
